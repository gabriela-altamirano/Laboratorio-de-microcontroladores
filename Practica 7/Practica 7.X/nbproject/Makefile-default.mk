...
FINAL_IMAGE=${DISTDIR}/Practica_7.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Practica_7.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
